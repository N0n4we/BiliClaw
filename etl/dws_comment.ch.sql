...
SELECT
    ...
    toDateTime(c.ctime, 'Asia/Shanghai') AS comment_ctime_dt,
    ...
    toDateTime(v.pubdate, 'Asia/Shanghai') AS video_pubdate_dt,
    v.ctime AS video_ctime,
    toDateTime(v.ctime, 'Asia/Shanghai') AS video_ctime_dt,
    ...
    toDate(toDateTime(c.ctime, 'Asia/Shanghai')) AS comment_date,
    toHour(toDateTime(c.ctime, 'Asia/Shanghai')) AS comment_hour,
    toDayOfWeek(toDateTime(c.ctime, 'Asia/Shanghai')) AS comment_day_of_week,
    toDate(toDateTime(v.pubdate, 'Asia/Shanghai')) AS video_publish_date,
    dateDiff('day', toDateTime(v.pubdate, 'Asia/Shanghai'), toDateTime(c.ctime, 'Asia/Shanghai')) AS comment_video_interval_days,
    dateDiff('hour', toDateTime(v.pubdate, 'Asia/Shanghai'), toDateTime(c.ctime, 'Asia/Shanghai')) AS comment_video_interval_hours,
    ...
    toDateTime(now(), 'Asia/Shanghai') AS etl_time,
    '1.0' AS data_version,
